...
Offset_0x01F492:
                ...
                sub.w   ($FFFFF7DA).w, D0
                cmpi.w  #$0280, D0
                bhi.w   Offset_0x01F4AA
                bra.w   Jmp_12_To_DisplaySprite                ; Offset_0x01F506
Offset_0x01F4AA:
                move.l  Obj_Control_Var_08(A0), A1                       ; $0034
                bsr.w   Jmp_03_To_DeleteObject_A1              ; Offset_0x01F512
                bra.w   Jmp_13_To_DeleteObject                 ; Offset_0x01F50C
Offset_0x01F4B6:
                movem.l D4/D5, -(A7)
                swap    D4
                swap    D5
...
Offset_0x01F4D6:
                ...
                move.w  Obj_Control_Var_04(A0), D0                       ; $0030
                bra.w   Jmp_07_To_MarkObjGone_2                ; Offset_0x01F530 
;===============================================================================
; Objeto 0x83 - Três plataformas girando na Neo Green Hill
; <<<-
;===============================================================================