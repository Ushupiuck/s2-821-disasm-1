...
; Offset_0x02BF70:
				...
				bra.w	Debug_Mode							   ; Offset_0x02DE64
;-------------------------------------------------------------------------------
...
Player_In_SS_Main:											   ; Offset_0x02BF94
				...
				bsr.w	Jmp_32_To_ModifySpriteAttr_2P		   ; Offset_0x02C614
...
Player_In_SS_OnWall:										   ; Offset_0x02C010
				bsr.w	Player_In_SS_Jump					   ; Offset_0x02C146
				bsr.w	Player_In_SS_Move					   ; Offset_0x02C050
				bsr.w	Player_In_SS_Fall					   ; Offset_0x02C246
				bra.s	Player_In_SS_Display				   ; Offset_0x02C02A
;-------------------------------------------------------------------------------
Player_In_SS_InAir											   ; Offset_0x02C01E
				bsr.w	Player_In_SS_Null					   ; Offset_0x02C18A
				bsr.w	Player_In_SS_Move					   ; Offset_0x02C050
				bsr.w	Player_In_SS_Fall					   ; Offset_0x02C246
;-------------------------------------------------------------------------------
...
Player_In_SS_Move:											   ; Offset_0x02C050
				...
				bsr.w	Player_In_SS_MoveLeft				   ; Offset_0x02C0E8
Offset_0x02C05C:
				btst	#$03, ($FFFFF602).w
				beq.s	Offset_0x02C068
				bsr.w	Player_In_SS_MoveRight				   ; Offset_0x02C118
Offset_0x02C068:
...
Offset_0x02C098:
				...
				bsr.w	Player_In_SS_Sub					   ; Offset_0x02C2D8
