...
Miles_Control:						   ; Offset_0x0111B2
		bsr.w	Miles_CPU_Control			   ; Offset_0x0112B6
...
Offset_0x0111DE:
		...
		bsr.w	Miles_Water					   ; Offset_0x011390
...
Miles_MdNormal:						   ; Offset_0x011448
		bsr.w	Miles_Spindash				   ; Offset_0x011AAC
		bsr.w	Miles_Jump					   ; Offset_0x0119C2
		bsr.w	Miles_SlopeResist			   ; Offset_0x011BA6
...
Offset_0x011490:
		bsr.w	Miles_JumpAngle				   ; Offset_0x011C5A
		bsr.w	Miles_Floor					   ; Offset_0x011CBA
		rts
;-------------------------------------------------------------------------------
...
Miles_Move:							   ; Offset_0x0114E4
		...
		bne.w	Offset_0x0115F6
		tst.w	Obj_Player_Control(A0)					 ; $002E
		bne.w	Offset_0x0115CA
		btst	#$02, ($FFFFF606).w
		beq.s	Offset_0x01150C
		bsr.w	Offset_0x011686
Offset_0x01150C:
		btst	#$03, ($FFFFF606).w
		beq.s	Offset_0x011518
		bsr.w	Offset_0x01170C
Offset_0x011518:
...
Miles_RollSpeed:							   ; Offset_0x01178C
		...
		asr.w	#$02, D4
		tst.b	(Player_Status_Flag).w				 ; $FFFFF7CA
		bne.w	Offset_0x011808
		tst.w	Obj_Player_Control(A0)					 ; $002E
		bne.s	Offset_0x0117C4
		btst	#$02, ($FFFFF606).w
		beq.s	Offset_0x0117B8
		bsr.w	Offset_0x01183E
Offset_0x0117B8:
		btst	#$03, ($FFFFF606).w
		beq.s	Offset_0x0117C4
		bsr.w	Offset_0x011862
Offset_0x0117C4:
		move.w	Obj_Inertia(A0), D0				 ; $0014
...
Offset_0x011930:
		...
		rts
Offset_0x011940:
		bra.w	Kill_Miles					   ; Offset_0x012544
Offset_0x011944:
...
Miles_Jump:							   ; Offset_0x0119C2
		...
		andi.b	#$70, D0
		beq.w	Offset_0x011A66
		moveq	#$00, D0
		move.b	Obj_Angle(A0), D0				 ; $0026
		addi.b	#$80, D0
		bsr.w	CalcRoomOverHead			   ; Offset_0x01405E
		cmpi.w	#$0006, D1
		blt.w	Offset_0x011A66
		move.w	#$0680, D2
		btst	#$06, Obj_Status(A0)					 ; $0022
...
Offset_0x011CD2:
		...
		andi.b	#$C0, D0
		cmpi.b	#$40, D0
		beq.w	Offset_0x011DA6
		cmpi.b	#$80, D0
		beq.w	Offset_0x011E08
		cmpi.b	#$C0, D0
		beq.w	Offset_0x011E64
...
Offset_0x011D44:
		...
		bsr.w	Miles_ResetOnFloor			   ; Offset_0x011EC6
		move.b	#$00, Obj_Ani_Number(A0)				 ; $001C
		move.b	D3, D0
		addi.b	#$20, D0
		andi.b	#$40, D0
...
Offset_0x011F44:
		bsr.w	Miles_HurtStop				   ; Offset_0x011F5E
		bsr.w	Miles_LevelBoundaries		   ; Offset_0x0118FE
		bsr.w	Miles_RecordMoves			   ; Offset_0x011376
		bsr.w	Miles_Animate				   ; Offset_0x012010
...
Miles_HurtStop:						   ; Offset_0x011F5E
		...
		addi.w	#$00E0, D0
		cmp.w	Obj_Y(A0), D0					 ; $000C
		bcs.w	Kill_Miles					   ; Offset_0x012544
		bsr.w	Miles_Floor					   ; Offset_0x011CBA
