...
Offset_0x02081E:
                ...
                ble.w   Jmp_15_To_DeleteObject                 ; Offset_0x020E5E
...
Offset_0x020848:
                ...
                beq.w   Jmp_14_To_DisplaySprite                ; Offset_0x020E58
                btst    #$02, Obj_Control_Var_01(A1)                     ; $002D
                bne.w   Offset_0x02088A
                move.w  Obj_X(A1), Obj_X(A0)                      ; $0008, $0008
                move.w  Obj_Y(A1), Obj_Y(A0)                      ; $000C, $000C
...
Offset_0x02095A:
                ...
                bpl.w   Jmp_14_To_DisplaySprite                ; Offset_0x020E58
                bsr.w   Jmp_02_To_ObjectFall                   ; Offset_0x020E88
                bsr.w   Jmp_03_To_ObjHitFloor                  ; Offset_0x020E7C
                tst.w   D1
                bpl.s   Offset_0x020978
                move.w  #$FE00, Obj_Speed_Y(A0)                          ; $0012
                add.w   D1, Obj_Y(A0)                                    ; $000C
Offset_0x020978:
                bra.w   Jmp_1B_To_MarkObjGone                  ; Offset_0x020E64     
;-------------------------------------------------------------------------------
Offset_0x02097C:
                move.l  Obj_Control_Var_08(A0), A1                       ; $0034
                cmpi.b  #$56, (A1)
